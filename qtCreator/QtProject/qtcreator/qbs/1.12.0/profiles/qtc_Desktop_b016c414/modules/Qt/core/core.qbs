...
Module {
    ...
    property stringList config: ["qt", "warn_on", "release", "incremental", "link_prl", "gdb_dwarf_index", "shared", "def_files_disabled", "exceptions", "no_mocdepend", "release", "stl", "qt_no_framework", "unix"]
    property stringList qtConfig: ["minimal-config", "small-config", "medium-config", "large-config", "full-config", "qt3support", "accessibility", "opengl", "shared", "reduce_exports", "reduce_relocations", "ipv6", "clock-gettime", "clock-monotonic", "mremap", "getaddrinfo", "ipv6ifname", "getifaddrs", "inotify", "system-jpeg", "system-mng", "system-png", "png", "system-tiff", "system-freetype", "system-zlib", "nis", "cups", "iconv", "glib", "dbus", "dbus-linked", "nas", "openssl", "x11sm", "xshape", "xvideo", "xsync", "xrender", "mitshm", "fontconfig", "xinput2", "xkb", "icu", "concurrent", "xmlpatterns", "audio-backend", "svg", "script", "scripttools", "declarative", "release", "phonon"]
    property path binPath: "/usr/lib/x86_64-linux-gnu/qt4/bin"
    property path incPath: "/usr/include/qt4"
    property path libPath: "/usr/lib/x86_64-linux-gnu"
    property path pluginPath: "/usr/lib/x86_64-linux-gnu/qt4/plugins"
    property string mkspecName: "linux-g++-64"
    property path mkspecPath: "/usr/share/qt4/mkspecs/linux-g++-64"
    ...
    property path docPath: "/usr/share/qt4/doc"
