...
Module {
    ...
    property string libFilePathDebug: "D:/Qt/Qt5.6.0/5.6/msvc2013_64/lib/Qt5Cored.lib"
    property string libFilePathRelease: "D:/Qt/Qt5.6.0/5.6/msvc2013_64/lib/Qt5Core.lib"
    ...
    cpp.includePaths: {
        var paths = ["D:/Qt/Qt5.6.0/5.6/msvc2013_64/include", "D:/Qt/Qt5.6.0/5.6/msvc2013_64/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib", "D:/Qt/Qt5.6.0/5.6/msvc2013_64/lib/qtmaind.lib"] : ["Shell32.lib", "D:/Qt/Qt5.6.0/5.6/msvc2013_64/lib/qtmain.lib"]);
        }
